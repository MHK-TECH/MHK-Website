...
(function(){
  ...
  footerHTML+='<a href="mailto:huzaifa@mhktech.dev" aria-label="Email"><svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" fill="none" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></a>';
  footerHTML+='</div>';
  footerHTML+='</div>';
  ...
  footerHTML+='<ul>';
  footerHTML+='<li><a href="mailto:huzaifa@mhktech.dev">huzaifa@mhktech.dev</a></li>';
